...
*   **Tempo Slider:** Adjust the speed from a slow `60 BPM` to an energetic `140 BPM`.
*   **Waveform Selector:** Shape your sound by choosing between classic synth waveforms: `Sine`, `Square`, `Sawtooth`, `Triangle` and other shapes.
